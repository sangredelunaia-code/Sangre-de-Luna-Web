...
(()=>{
  ...
  const loadScript=(name,tag)=>{if(document.querySelector(`script[${tag}]`))return;const s=document.createElement('script');s.src=`${CDN}/${name}`;s.defer=true;s.setAttribute(tag,'1');document.head.appendChild(s)};
