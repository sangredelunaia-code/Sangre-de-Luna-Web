...
const pages={
  ...
  personajes:{file:'index.html',path:'/personajes',title:'Personajes de Sangre de Luna | Conoce la Manada',description:'En el mundo de Sangre de Luna, reinos, linajes y alianzas se sostienen por quienes los defienden. Conoce a los personajes de la serie y descubre sus historias dentro del universo oficial.'},
  historias:{file:'index.html',path:'/historias',title:'Historias de Sangre de Luna | Lee el Universo Oficial',description:'Sangre de Luna narra un mundo de linajes, alianzas, secretos y antiguos conflictos. Lee las historias oficiales y descubre cómo evoluciona la serie capítulo a capítulo.'},
  episodios:{file:'index.html',path:'/episodios',title:'Sangre de Luna | Mira la Serie y sus Episodios',description:'Sangre de Luna es una serie cinematográfica de fantasía épica sobre reinos, linajes, alianzas y secretos. Mira los episodios y sigue su historia capítulo a capítulo.'},
  musica:{file:'index.html',path:'/musica',title:'Música de Sangre de Luna | Sonidos del Universo',description:'La música acompaña los reinos, alianzas y momentos que construyen el mundo de Sangre de Luna. Escucha las canciones y temas del universo oficial de la serie.'},
  galeria:{file:'index.html',path:'/galeria',title:'Galería de Sangre de Luna | Arte del Mundo Oficial',description:'Descubre visualmente el mundo de Sangre de Luna, una serie de reinos, linajes, alianzas y secretos. Explora personajes, territorios y escenas de su universo oficial.'},
